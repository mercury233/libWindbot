...
namespace WindBot
{
    [Register("libWindbot.WindbotProgram")]
    public class Program
    {
        ...
        [Export("initAndroid")]
        public static void InitAndroid(AssetManager assetManager, string databasePath)
        {
            Rand = new Random();
            Assets = assetManager;
            DecksManager.Init();
        ...
        public static void InitAndroid2(string databasePath)
        {
            Rand = new Random();
